...
{
    sudo apt install -y sway swaybg swayidle swaylock xwayland xdg-desktop-portal-wlr waybar wofi wlogout sway-notification-center qt5ct libglib2.0-bin grim slurp
} &
show_spinner $!
