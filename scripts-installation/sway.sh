...
{
    sudo apt install -y sway swaybg swayidle swaylock xwayland xdg-desktop-portal-wlr waybar wofi wlogout sway-notification-center qt5ct libglib2.0-bin grim slurp qtwayland5
} &
show_spinner $!
...
{
    {
        ...
        grep -q "QT_QPA_PLATFORM=wayland-egl" /etc/environment || echo "QT_QPA_PLATFORM=wayland-egl" | sudo tee -a /etc/environment
